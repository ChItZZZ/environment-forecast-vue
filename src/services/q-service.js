export default {
    ...
    tokenHttpGet(resourceObject, paramObject) {
    ...
    tokenHttpPost(resourceObject, paramObject, reqBodyObject) {
        var deferred = $q.defer();
        resourceObject({
    ...
    tokenHttpPut(resourceObject, paramObject, reqBodyObject) {
        var deferred = $q.defer();
        resourceObject({
            'x-auth-token': $localStorage.token
    ...
    tokenHttpDelete(resourceObject, paramObject, reqBodyObject) {
        var deferred = $q.defer();
        resourceObject({
            'x-auth-token': $localStorage.token
